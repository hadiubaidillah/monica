...
<head>
	...
	<title>Monica Administrator</title>

	<link rel="icon" type="image/png" sizes="32x32" href="${assetPath}/../images/favicon.png">

	<!-- Fontfaces CSS-->
	<link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.1/css/all.min.css" rel="stylesheet" media="all">
	<link href="https://cdn.jsdelivr.net/npm/font-awesome@4.7.0/css/font-awesome.min.css" rel="stylesheet" media="all">
	<link href="https://cdn.jsdelivr.net/npm/material-design-iconic-font@2.2.0/dist/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">

	<!-- Bootstrap core CSS-->
	<link href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css" rel="stylesheet">

	<!-- Vendor CSS-->
	<link href="https://cdn.jsdelivr.net/npm/bootstrap-progressbar@0.9.0/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet" media="all">
	<link href="https://cdn.jsdelivr.net/npm/wowjs@1.1.3/css/libs/animate.min.css" rel="stylesheet" media="all">
	<link href="https://cdn.jsdelivr.net/npm/hamburgers@1.1.3/dist/hamburgers.min.css" rel="stylesheet" media="all">
	<link href="https://cdn.jsdelivr.net/npm/slick-slider@1.8.2/slick/slick.css" rel="stylesheet" media="all">
	<link href="https://cdn.jsdelivr.net/npm/slick-slider@1.8.2/slick/slick-theme.css" rel="stylesheet" media="all">
	...
	<link href="https://cdnjs.cloudflare.com/ajax/libs/apexcharts/3.22.1/apexcharts.min.css" rel="stylesheet">
	<link href="https://unpkg.com/nprogress@0.2.0/nprogress.css" rel="stylesheet">

	<script>const ctx = "${contextPath}";</script>
